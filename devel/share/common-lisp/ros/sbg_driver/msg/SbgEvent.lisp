...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SbgEvent>)))
  ...
  (cl:format cl:nil "# SBG Ellipse Messages~%Header header~%~%# Time since sensor is powered up μs ~%uint32 time_stamp~%~%# True if we have received events at a higher rate than 1 kHz.~%bool overflow~%~%# True if at least two events have been received.~%bool offset_0_valid~%~%# True if at least three events have been received.~%bool offset_1_valid~%~%# True if at least four events have been received.~%bool offset_2_valid~%~%# True if five events have been received.~%bool offset_3_valid~%~%~%# Time offset for the second received event. (μs)~%uint16 time_offset_0~%~%# Time offset for the third received event. (μs)~%uint16 time_offset_1~%~%# Time offset for the fourth received event. (μs)~%uint16  time_offset_2~%~%# Time offset for the fifth received event. (μs)~%uint16  time_offset_3~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SbgEvent)))
  "Returns full string definition for message of type 'SbgEvent"
  (cl:format cl:nil "# SBG Ellipse Messages~%Header header~%~%# Time since sensor is powered up μs ~%uint32 time_stamp~%~%# True if we have received events at a higher rate than 1 kHz.~%bool overflow~%~%# True if at least two events have been received.~%bool offset_0_valid~%~%# True if at least three events have been received.~%bool offset_1_valid~%~%# True if at least four events have been received.~%bool offset_2_valid~%~%# True if five events have been received.~%bool offset_3_valid~%~%~%# Time offset for the second received event. (μs)~%uint16 time_offset_0~%~%# Time offset for the third received event. (μs)~%uint16 time_offset_1~%~%# Time offset for the fourth received event. (μs)~%uint16  time_offset_2~%~%# Time offset for the fifth received event. (μs)~%uint16  time_offset_3~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
