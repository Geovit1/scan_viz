...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SbgGpsHdt>)))
  ...
  (cl:format cl:nil "# SBG Ellipse Messages~%Header header~%~%# Time since sensor is powered up μs ~%uint32 time_stamp~%~%# GPS True Heading status.~%# 0 SOL_COMPUTED		A valid solution has been computed.~%# 1 INSUFFICIENT_OBS	Not enough valid SV to compute a solution.~%# 2 INTERNAL_ERROR		An internal error has occurred.~%# 3 HEIGHT_LIMIT		The height limit has been exceeded.~%uint16 status~%~%# GPS Time of Week ms~%uint32 tow~%~%# True heading angle (0 to 360°). °~%float32 true_heading~%~%# 1 σ True heading estimated accuracy (0 to 360°). °~%float32 true_heading_acc~%~%# Pitch angle from the master to the rover °~%float32 pitch~%~%# 1 σ pitch estimated accuracy °~%float32 pitch_acc~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SbgGpsHdt)))
  "Returns full string definition for message of type 'SbgGpsHdt"
  (cl:format cl:nil "# SBG Ellipse Messages~%Header header~%~%# Time since sensor is powered up μs ~%uint32 time_stamp~%~%# GPS True Heading status.~%# 0 SOL_COMPUTED		A valid solution has been computed.~%# 1 INSUFFICIENT_OBS	Not enough valid SV to compute a solution.~%# 2 INTERNAL_ERROR		An internal error has occurred.~%# 3 HEIGHT_LIMIT		The height limit has been exceeded.~%uint16 status~%~%# GPS Time of Week ms~%uint32 tow~%~%# True heading angle (0 to 360°). °~%float32 true_heading~%~%# 1 σ True heading estimated accuracy (0 to 360°). °~%float32 true_heading_acc~%~%# Pitch angle from the master to the rover °~%float32 pitch~%~%# 1 σ pitch estimated accuracy °~%float32 pitch_acc~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
