...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SbgMag>)))
  ...
  (cl:format cl:nil "# SBG Ellipse Messages~%Header header~%~%# Time since sensor is powered up (µs)~%uint32 time_stamp~%~%# Magnetometer output (X, Y, Z)~%geometry_msgs/Vector3 mag~%~%# Accelerometer output (X, Y, Z) in m/s2~%geometry_msgs/Vector3 accel~%~%# Status~%SbgMagStatus status~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%================================================================================~%MSG: sbg_driver/SbgMagStatus~%# SBG Ellipse Messages~%# Submessage~%~%# True if the magnetometer X has passed the self test.~%bool mag_x~%~%# True if the magnetometer Y has passed the self test.~%bool mag_y~%~%# True if the magnetometer Z has passed the self test.~%bool mag_z~%~%# True if the accelerometer X has passed the self test.~%bool accel_x~%~%# True if the accelerometer Y has passed the self test.~%bool accel_y~%~%# True if the accelerometer Z has passed the self test.~%bool accel_z~%~%# True if magnetometer is not saturated~%bool mags_in_range~%~%# True if accelerometer is not saturated~%bool accels_in_range~%~%# True if magnetometer seems to be calibrated~%bool calibration~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SbgMag)))
  "Returns full string definition for message of type 'SbgMag"
  (cl:format cl:nil "# SBG Ellipse Messages~%Header header~%~%# Time since sensor is powered up (µs)~%uint32 time_stamp~%~%# Magnetometer output (X, Y, Z)~%geometry_msgs/Vector3 mag~%~%# Accelerometer output (X, Y, Z) in m/s2~%geometry_msgs/Vector3 accel~%~%# Status~%SbgMagStatus status~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%================================================================================~%MSG: sbg_driver/SbgMagStatus~%# SBG Ellipse Messages~%# Submessage~%~%# True if the magnetometer X has passed the self test.~%bool mag_x~%~%# True if the magnetometer Y has passed the self test.~%bool mag_y~%~%# True if the magnetometer Z has passed the self test.~%bool mag_z~%~%# True if the accelerometer X has passed the self test.~%bool accel_x~%~%# True if the accelerometer Y has passed the self test.~%bool accel_y~%~%# True if the accelerometer Z has passed the self test.~%bool accel_z~%~%# True if magnetometer is not saturated~%bool mags_in_range~%~%# True if accelerometer is not saturated~%bool accels_in_range~%~%# True if magnetometer seems to be calibrated~%bool calibration~%~%~%"))
